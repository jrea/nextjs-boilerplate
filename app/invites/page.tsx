    ...
    <div className="container mx-auto flex flex-col">
      ...
      <div className="p-10 flex flex-col gap-4">
        ...
        <div>
          ...
          `nile.auth.getSession` here, but since we need to get the user's info,
          and the endpoint returns `Response` for unauthorized (or other
        ...
        <Tabs defaultValue="tables">
          ...
          <TabsContent value="tables">
            <Code file="app/invites/TenantsAndTables.tsx"></Code>
          </TabsContent>
          <TabsContent value="invite">
            <Code file="app/invites/InviteUserToTenant.tsx"></Code>
          </TabsContent>
          <TabsContent value="invitesTable">
            <Code file="app/invites/InvitesTable.tsx"></Code>
          </TabsContent>
          <TabsContent value="membersTable">
            <Code file="app/invites/MembersTable.tsx"></Code>
          </TabsContent>
          <TabsContent value="actions">
            <Code file="app/invites/actions.ts"></Code>
          </TabsContent>
        </Tabs>
        <div>
