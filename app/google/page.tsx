    ...
    <div className="container mx-auto pt-40">
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          but by this point in the flow, we still don't have a valid session. In
          order to convert the oauth response from google and query, we can
          automatically set the context from the{" "}
        ...
        nile.db.query("select * from todos2")` without the protections of
        checking for a valid session. If you are logged out, you will still see
